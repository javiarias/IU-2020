...
//
$('#displayPrinter').click(function(e) {
  document.getElementById("printers").style.display = "inline";
  document.getElementById("groups").style.display = "none";
  document.getElementById("jobs").style.display = "none";

  if(document.getElementById("displayPrinter").classList.contains('btn-outline-secondary'))
    document.getElementById("displayPrinter").classList.remove('btn-outline-secondary');
  if(!document.getElementById("displayPrinter").classList.contains('btn-outline-primary'))
    document.getElementById("displayPrinter").classList.add('btn-outline-primary');

  if(document.getElementById("displayGroups").classList.contains('btn-outline-primary'))
    document.getElementById("displayGroups").classList.remove('btn-outline-primary');
  if(!document.getElementById("displayGroups").classList.contains('btn-outline-secondary'))
    document.getElementById("displayGroups").classList.add('btn-outline-secondary');

  if(document.getElementById("displayJobs").classList.contains('btn-outline-primary'))
    document.getElementById("displayJobs").classList.remove('btn-outline-primary');
  if(!document.getElementById("displayJobs").classList.contains('btn-outline-secondary'))
    document.getElementById("displayJobs").classList.add('btn-outline-secondary');
});

$('#displayGroups').click(function(e) {
  document.getElementById("printers").style.display = "none";
  document.getElementById("groups").style.display = "inline";
  document.getElementById("jobs").style.display = "none";

  if(document.getElementById("displayGroups").classList.contains('btn-outline-secondary'))
    document.getElementById("displayGroups").classList.remove('btn-outline-secondary');
  if(!document.getElementById("displayGroups").classList.contains('btn-outline-primary'))
    document.getElementById("displayGroups").classList.add('btn-outline-primary');

  if(document.getElementById("displayPrinter").classList.contains('btn-outline-primary'))
    document.getElementById("displayPrinter").classList.remove('btn-outline-primary');
  if(!document.getElementById("displayPrinter").classList.contains('btn-outline-secondary'))
    document.getElementById("displayPrinter").classList.add('btn-outline-secondary');
...
$('#displayJobs').click(function(e) {
  document.getElementById("printers").style.display = "none";
  document.getElementById("groups").style.display = "none";
  document.getElementById("jobs").style.display = "inline";

  if(document.getElementById("displayJobs").classList.contains('btn-outline-secondary'))
    document.getElementById("displayJobs").classList.remove('btn-outline-secondary');
  if(!document.getElementById("displayJobs").classList.contains('btn-outline-primary'))
    document.getElementById("displayJobs").classList.add('btn-outline-primary');
